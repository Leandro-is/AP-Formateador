...
namespace IS.DocumenFormater.api.Controllers
{
    ...
    public class FreeController : Controller
    {
        ...
        private readonly ILogger<FreeController> _logger;

        public FreeController(
            IConfiguration configuration,
            IPdfFormats pdfFormats,
            IHostingEnvironment hostingEnvironment,
            ILogger<FreeController> logger)
        {
        ...
        public ActionResult TestSolicitudCredito()
        {
            ...
            String file = GetFREEClausulaProteccionPDF(_pdfFormats.FREE_CLAUSULA_PROTECCION, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestContratoCredito()
        {
            ...
            String file = GetFREEContratoMultiproductoPDF(_pdfFormats.FREE_CONTRATO_MULTIPRODUCTO, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestCartillaCuenta()
        {
            ...
            String file = GetFREEResumenPDF(_pdfFormats.FREE_HOJA_RESUMEN, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestSeguroDesgravamen()
        {
            ...
            String file = GetFREEInfoPDF(_pdfFormats.FREE_INFORMACION, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestSeguroOptativo()
        {
            ...
            String file = GetFREEDesgravamenPDF(_pdfFormats.FREE_DESGRAVAMEN, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestHojaAceptacion()
        {
            ...
            String file = GetFREESolicitudAfiliacionPDF(_pdfFormats.FREE_SOLICITUD_AFILIACION, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestHojaOptativo()
        {
            ...
            String file = GetFREETarifarioPDF(_pdfFormats.FREE_TARIFARIO, request/*, FingerprintImage, BarCode*/);
        ...
        //1
        [Route("freeclausulaproteccionGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREEClausulaProteccionGenerate([FromBody] BpmRequest request)
        {
            ...
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string solicitudGenerated = GetFREEClausulaProteccionPDF(_pdfFormats.FREE_CLAUSULA_PROTECCION, request/*, FingerprintImage, ""*/);
                ...
                {
                    ExceptionManager.Instance.ManageException<FreeController>(ex, _logger);
        ...
        //2
        [Route("freecontratomultiproductoGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREEContratoMultiproductoGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string contratoGenerated = GetFREEContratoMultiproductoPDF(_pdfFormats.FREE_CONTRATO_MULTIPRODUCTO, request/*, FingerprintImage, ""*/);
        ...
        //3
        [Route("freeresumenGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREEResumenGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string garantiaGenerated = GetFREEResumenPDF(_pdfFormats.FREE_HOJA_RESUMEN, request/*, FingerprintImage, ""*/);
        ...
        //4
        [Route("freeinfoGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREEInfoGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string pagareGenerated = GetFREEInfoPDF(_pdfFormats.FREE_INFORMACION, request/*, FingerprintImage, ""*/);
        ...
        //5
        [Route("freedesgravamenGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREEDesgravamenGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string desgravamenGenerated = GetFREEDesgravamenPDF(_pdfFormats.FREE_DESGRAVAMEN, request/*, FingerprintImage, ""*/);
        ...
        //6
        [Route("freesolicitudafiliacionGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREESolicitudAfiliacionGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string hojaAceptacion = GetFREESolicitudAfiliacionPDF(_pdfFormats.FREE_SOLICITUD_AFILIACION, request/*, FingerprintImage, ""*/);
        ...
        //7
        [Route("freetarifarioGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> FREETarifarioGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string hojaOptativo = GetFREETarifarioPDF(_pdfFormats.FREE_TARIFARIO, request/*, FingerprintImage, ""*/);
        ...
        //1
        private String GetFREEClausulaProteccionPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            ...
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 428, 605, 0.0f);
            }

            if (request.SegundoConsentimiento == "true")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 173, 509, 0.0f);
            }
            else if (request.SegundoConsentimiento == "false")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 429, 509, 0.0f);
            }
...
*/
        ...
        //2
        private String GetFREEContratoMultiproductoPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));

            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {request.LugarTransaccion}", 31, 9, iTextSharp.text.Element.ALIGN_RIGHT, 110, 314, 0.0f);
            ...
            if (formatTransaccion)
            {
                ...
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("dd")}", 31, 9, iTextSharp.text.Element.ALIGN_CENTER, 160, 314, 0.0f);
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("MM")}", 31, 9, iTextSharp.text.Element.ALIGN_CENTER, 200, 314, 0.0f);
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("yyyy")}", 31, 9, iTextSharp.text.Element.ALIGN_LEFT, 250, 314, 0.0f);
            }
 ...
 */
        ...
        //3
        private String GetFREEResumenPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
            ...
            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {request.LugarTransaccion}", 3, 9, iTextSharp.text.Element.ALIGN_RIGHT, 105, 704, 0.0f);
            ...
            if (formatTransaccion)
            {
                ...
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("yyyy")}", 3, 9, iTextSharp.text.Element.ALIGN_LEFT, 220, 704, 0.0f);
            }
        ...
        //4 
        private String GetFREEInfoPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
...
*/
        ...
        //5
        private String GetFREEDesgravamenPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
            ...
            if (request.TipoMoneda == "Soles")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 9, iTextSharp.text.Element.ALIGN_LEFT, 130, 723, 0.0f);
            }
            else if (request.TipoMoneda == "Dolares")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 9, iTextSharp.text.Element.ALIGN_LEFT, 170, 723, 0.0f);
            }
            else
            {
            ...
            if (request.TipoCredito == "DINERS CLUB FREE") { 
            ...
            else if (request.TipoCredito == "DCM SPECIAL EDITION") { 
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 8, iTextSharp.text.Element.ALIGN_LEFT, 38, 682, 0.0f);
            }
            else if (request.TipoCredito == "DINERS CLUB") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 8, iTextSharp.text.Element.ALIGN_LEFT, 235, 698, 0.0f);
            }
                ...
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 8, iTextSharp.text.Element.ALIGN_LEFT, 420, 698, 0.0f);
            }
            else if (request.TipoCredito == "DINERS HIRAOKA") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 8, iTextSharp.text.Element.ALIGN_LEFT, 420, 682, 0.0f);
            }
            else
            {
            ...
            else if (request.TipoDocumentoCliente == "CE") { pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 9, iTextSharp.text.Element.ALIGN_LEFT, 356, 628, 0.0f); }
            else
            {
            ...
            if (request.TipoMoneda == "Soles")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 130, 721, 0.0f);
            }
            else if (request.TipoMoneda == "Dolares")
            {
            ...
            if (request.TipoCredito == "DINERS CLUB FREE") { 
                ...
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 38, 680, 0.0f);
            }
            else if (request.TipoCredito == "DINERS CLUB") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 235, 696, 0.0f);
            }
            else if (request.TipoCredito == "CARTE BLANCHE") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 235, 680, 0.0f);
            }
            else if (request.TipoCredito == "DINERS CLUB MILES") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 420, 696, 0.0f);
            }
            else if (request.TipoCredito == "DINERS HIRAOKA") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 420, 680, 0.0f);
            }
            else
            {
        ...
        //6
        private String GetFREESolicitudAfiliacionPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            // String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
...
*/
        ...
        //7
        private String GetFREETarifarioPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
