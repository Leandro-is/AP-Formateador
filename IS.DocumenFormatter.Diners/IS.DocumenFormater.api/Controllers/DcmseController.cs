...
namespace IS.DocumenFormater.api.Controllers
{
    ...
    public class DCMSEController : Controller
    {
        private readonly IConfiguration _configuration;
        private readonly IPdfFormats _pdfFormats;
        private readonly IHostingEnvironment _hostingEnvironment;
        private readonly ILogger<DCMSEController> _logger;

        public DCMSEController(
            IConfiguration configuration,
            IPdfFormats pdfFormats,
            IHostingEnvironment hostingEnvironment,
            ILogger<DCMSEController> logger)
        {
        ...
        public ActionResult TestSolicitudCredito()
        {
            ...
            String file = GetDCMSEClausulaProteccionPDF(_pdfFormats.DCMSE_CLAUSULA_PROTECCION, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestContratoCredito()
        {
            ...
            String file = GetDCMSEContratoMultiproductoPDF(_pdfFormats.DCMSE_CONTRATO_MULTIPRODUCTO, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestCartillaCuenta()
        {
            ...
            String file = GetDCMSEResumenPDF(_pdfFormats.DCMSE_HOJA_RESUMEN, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestSeguroDesgravamen()
        {
            ...
            String file = GetDCMSEInfoPDF(_pdfFormats.DCMSE_INFORMACION, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestSeguroOptativo()
        {
            ...
            String file = GetDCMSEDesgravamenPDF(_pdfFormats.DCMSE_DESGRAVAMEN, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestHojaAceptacion()
        {
            ...
            String file = GetDCMSESolicitudAfiliacionPDF(_pdfFormats.DCMSE_SOLICITUD_AFILIACION, request/*, FingerprintImage, BarCode*/);
        ...
        public ActionResult TestHojaOptativo()
        {
            ...
            String file = GetDCMSETarifarioPDF(_pdfFormats.DCMSE_TARIFARIO, request/*, FingerprintImage, BarCode*/);
        ...
        //1
        [Route("dcmseclausulaproteccionGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSEClausulaProteccionGenerate([FromBody] BpmRequest request)
        {
            ...
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string solicitudGenerated = GetDCMSEClausulaProteccionPDF(_pdfFormats.DCMSE_CLAUSULA_PROTECCION, request/*, FingerprintImage, ""*/);
                ...
                {
                    ExceptionManager.Instance.ManageException<DCMSEController>(ex, _logger);
        ...
        //2
        [Route("dcmsecontratomultiproductoGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSEContratoMultiproductoGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string contratoGenerated = GetDCMSEContratoMultiproductoPDF(_pdfFormats.DCMSE_CONTRATO_MULTIPRODUCTO, request/*, FingerprintImage, ""*/);
        ...
        //3
        [Route("dcmseresumenGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSEResumenGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string garantiaGenerated = GetDCMSEResumenPDF(_pdfFormats.DCMSE_HOJA_RESUMEN, request/*, FingerprintImage, ""*/);
        ...
        //4
        [Route("dcmseinfoGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSEInfoGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string pagareGenerated = GetDCMSEInfoPDF(_pdfFormats.DCMSE_INFORMACION, request/*, FingerprintImage, ""*/);
        ...
        //5
        [Route("dcmsedesgravamenGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSEDesgravamenGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string desgravamenGenerated = GetDCMSEDesgravamenPDF(_pdfFormats.DCMSE_DESGRAVAMEN, request/*, FingerprintImage, ""*/);
        ...
        //6
        [Route("dcmsesolicitudafiliacionGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSESolicitudAfiliacionGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string hojaAceptacion = GetDCMSESolicitudAfiliacionPDF(_pdfFormats.DCMSE_SOLICITUD_AFILIACION, request/*, FingerprintImage, ""*/);
        ...
        //7
        [Route("dcmsetarifarioGenerate")]
        [HttpPost]
        public async Task<ActionResult<ContractResponse>> DCMSETarifarioGenerate([FromBody] BpmRequest request)
        {
            ContractResponse response = new ContractResponse();
            using (_logger.BeginScope("SIGN Request Opening"))
            {
                ...
                try
                {
                    ...
                    await Task.Run(async () =>
                    {
                        ...
                        string hojaOptativo = GetDCMSETarifarioPDF(_pdfFormats.DCMSE_TARIFARIO, request/*, FingerprintImage, ""*/);
        ...
        //1
        private String GetDCMSEClausulaProteccionPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            ...
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 175, 605, 0.0f);
            }
            else if (request.PrimerConsentimiento == "false")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 427, 605, 0.0f);
            }

            if (request.SegundoConsentimiento == "true")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 175, 509, 0.0f);
            }
            else if (request.SegundoConsentimiento == "false")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 2, 9, iTextSharp.text.Element.ALIGN_LEFT, 427, 509, 0.0f);
            }
...
*/
        ...
        //2
        private String GetDCMSEContratoMultiproductoPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));

            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {request.LugarTransaccion}", 31, 9, iTextSharp.text.Element.ALIGN_RIGHT, 110, 315, 0.0f);
            ...
            if (formatTransaccion)
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("dd")}", 1, 9, iTextSharp.text.Element.ALIGN_CENTER, 60, 743, 0.0f);
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("MM")}", 1, 9, iTextSharp.text.Element.ALIGN_CENTER, 100, 743, 0.0f);
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("yyyy")}", 1, 9, iTextSharp.text.Element.ALIGN_LEFT, 130, 743, 0.0f);

                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("dd")}", 31, 9, iTextSharp.text.Element.ALIGN_CENTER, 160, 315, 0.0f);
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("MM")}", 31, 9, iTextSharp.text.Element.ALIGN_CENTER, 200, 315, 0.0f);
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("yyyy")}", 31, 9, iTextSharp.text.Element.ALIGN_LEFT, 250, 315, 0.0f);
            }

            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $"{request.NombresCliente} {request.ApPaternoCliente} {request.ApMaternoCliente}", 31, 10, iTextSharp.text.Element.ALIGN_LEFT, 250, 218, 0.0f);
            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $"{request.NroDocumentoCliente}", 31, 10, iTextSharp.text.Element.ALIGN_LEFT, 180, 208, 0.0f);
 ...
 */
        ...
        //3
        private String GetDCMSEResumenPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
            ...
            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {request.LugarTransaccion}", 3, 9, iTextSharp.text.Element.ALIGN_RIGHT, 100, 704, 0.0f);
            ...
            if (formatTransaccion)
            {
                ...
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $" {fechaTransaccion.ToString("yyyy")}", 3, 9, iTextSharp.text.Element.ALIGN_LEFT, 230, 704, 0.0f);
            }
            ...
            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $"{request.NroDocumentoCliente}", 3, 10, iTextSharp.text.Element.ALIGN_LEFT, 155, 600, 0.0f);

            pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, $"{request.NombresCliente} {request.ApPaternoCliente} {request.ApMaternoCliente}", 3, 10, iTextSharp.text.Element.ALIGN_LEFT, 350, 47, 0.0f);
        ...
        //4 
        private String GetDCMSEInfoPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
...
*/
        ...
        //5
        private String GetDCMSEDesgravamenPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
            ...
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 9, iTextSharp.text.Element.ALIGN_LEFT, 168, 722, 0.0f);
            }
            else
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "", 4, 9, iTextSharp.text.Element.ALIGN_LEFT, 190, 723, 0.0f);
            }
            ...
            if (request.TipoCredito == "DCM SPECIAL EDITION") { 
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 8, iTextSharp.text.Element.ALIGN_LEFT, 36, 682, 0.0f);
            }
                ...
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 4, 8, iTextSharp.text.Element.ALIGN_LEFT, 36, 696, 0.0f);
            }
            else
            {
            ...
            if (request.TipoMoneda == "Soles")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 128, 720, 0.0f);
            }
            else if (request.TipoMoneda == "Dolares")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 170, 720, 0.0f);
            }
            else
            {
            ...
            //if (request.TipoCredito == "DINERS CLUB FREE") { 
            //    pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 38, 696, 0.0f);
            //}
            if (request.TipoCredito == "DCM SPECIAL EDITION") { 
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 36, 680, 0.0f);
            }
            else if (request.TipoCredito == "DINERS CLUB") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 235, 695, 0.0f);
            }
            else if (request.TipoCredito == "CARTE BLANCHE") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 235, 680, 0.0f);
            }
            else if (request.TipoCredito == "DINERS CLUB MILES") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 420, 695, 0.0f);
            }
            else if (request.TipoCredito == "DINERS HIRAOKA") {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 8, iTextSharp.text.Element.ALIGN_LEFT, 36, 695, 0.0f);
            }
            else
            {
            ...
            else if (request.TipoDocumentoCliente == "CE") { pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 357, 626, 0.0f); }
            else
            {
            ...
            if (request.PrimerConsentimiento == "true")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 200, 222, 0.0f);
            }
            else if (request.PrimerConsentimiento == "false")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 352, 222, 0.0f);
            }

            if (request.SegundoConsentimiento == "true")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 200, 168, 0.0f);
            }
            else if (request.SegundoConsentimiento == "false")
            {
                pdfbase64 = PdfWorker.WriteTextInPdf(pdfbase64, "X", 6, 9, iTextSharp.text.Element.ALIGN_LEFT, 352, 168, 0.0f);
            }
        ...
        //6
        private String GetDCMSESolicitudAfiliacionPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            // String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
...
*/
        ...
        //7
        private String GetDCMSETarifarioPDF(FormatSettings formatSettings, BpmRequest request/*, String FingerprintImage, String BarCode*/)
        {
            String pdfbase64 = Convert.ToBase64String(System.IO.File.ReadAllBytes(Path.Combine(_hostingEnvironment.WebRootPath, formatSettings.PathFileBase)));
